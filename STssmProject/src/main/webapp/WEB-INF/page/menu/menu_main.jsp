...
<body>
	<a href="menu/loadadd.do" class="btn btn-info">添加下级菜单</a>
	<a href="menu/loadupdate.do?menuId=${menu.menuId}" class="btn btn-primary">修改菜单</a>
	...
	<div class="row">
		<div class="col-sm-6">
			<div class="form-group">
				...
				<div class="col-sm-9">
					<p class="form-control-static" name>${menu.menuName }</p>
				</div>
			</div>
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group">
				...
				<div class="col-sm-5">
					<p class="form-control-static">${menu.prentName}</p>
				</div>
			</div>
		</div>
		<div class="col-sm-12">
