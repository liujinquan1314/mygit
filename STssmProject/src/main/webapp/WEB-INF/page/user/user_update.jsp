...
<body>
	...
	<form action="user/update2.do" method="post" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" name="userAge"
							placeholder="请输入用户年龄" value="${user.userAge}" />
					</div>
				</div>
			</div>
			<div class="col-sm-5">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" name="userSalary"
							placeholder="请输入薪资" value="${user.userSalary}" />
					</div>
				</div>
			</div>
		</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" name="userAccount"
							placeholder="请输入用户账号" value="${user.userAccount}" />
					</div>
				</div>
			</div>
			<div class="col-sm-5">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="password" class="form-control" name="userPassword"
							placeholder="请输入用户密码" value="${user.userPassword}" />
					</div>
				</div>
			</div>
